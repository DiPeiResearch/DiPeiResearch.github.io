...
<div class="card-grid card-grid--two">
  <section class="site-card">
    <p class="card-label">Public Health</p>
    <h3>Population, policy, and equity</h3>
    <p>Tobacco regulation, prevention, cessation, global tobacco control, and disparities define the public health problems I study.</p>
  </section>
  <section class="site-card">
    <p class="card-label">Health Communication</p>
    <h3>Messages, exposure, and response</h3>
    <p>Message design, media exposure, attention, cognition, emotion, and persuasion explain how communication can shape health outcomes.</p>
  </section>
</div>
...
<div class="evidence-list">
  <div><strong>Causal evidence</strong><span>Randomized experiments test message themes, product claims, and policy communication under controlled contrasts.</span></div>
  <div><strong>Process evidence</strong><span>Eye-tracking and qualitative inquiry show what people attend to, how they interpret messages, and why responses emerge.</span></div>
  <div><strong>Population evidence</strong><span>Surveys and cross-national data examine exposure, beliefs, and heterogeneity across populations and settings.</span></div>
</div>
